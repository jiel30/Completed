...
typedef ics::HashOpenMap<WordQueue,FollowSet>   Corpus;
...
//(1)Almost All Array Implementations (except HeapPriorityQueue and HashOpenMap)
//  use a load factor threshold of .75         (line in read_corpus)
//  read_corpus time                   =
//  print_corpus (sort not print) time =

//(2)Only ArrayQueue Implementation (use HeapPriorityQueue, HashOpenMap, and HashOpenSet)
//  use a load factor threshold of .75 in both (lines in read_corpus)
//  read_corpus time                   =
//  print_corpus (sort not print) time =

//(3)Only ArrayQueue Implementation (use HeapPriorityQueue, HashOpenMap, and HashOpenSet)
//  use a load factor threshold of .50 in HashOpenMap, .75 in HashOpenSet both (lines in read_corpus)
//  read_corpus time                   =
//  print_corpus (sort not print) time =

//(4)Only ArrayQueue Implementation (use HeapPriorityQueue, HashOpenMap, and HashOpenSet)
//  use a load factor threshold of .95 in HashOpenMap, .75 in HashOpenSet both (lines in read_corpus)
//  read_corpus time                   =
//  print_corpus (sort not print) time =

//Briefly explain (in a comment below) what is interesting
//about comparing the times below (and explain why it occurs).
//  1) Compare times for (1) and (2)
//
//  2) Compare times for (2) and (3)
//
//  3) Compare times for (2) and (4)
