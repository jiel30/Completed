...
//
//typedef ics::LinkedSet<std::string> SetTypeStr;
//typedef ics::LinkedSet<int>         SetTypeInt;
//
...
//
//
//::testing::AssertionResult contains(const SetTypeStr& s, std::string values) {
...
//  load(s,"fcijbdegah");
//  SetTypeStr s2(s);
////  std::cout << "constructor copy successful" << std::endl;
