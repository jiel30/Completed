...
//
//typedef ics::LinkedPriorityQueue<std::string,gt_string>   PriorityQueueTypeStr;
//typedef ics::LinkedPriorityQueue<std::string,gt_string2>  PriorityQueueTypeStrR;
//typedef ics::LinkedPriorityQueue<int,gt_int>              PriorityQueueTypeInt;
//typedef ics::LinkedPriorityQueue<std::string>             PriorityQueueTypeNone;
//
...
//  PriorityQueueTypeStr q1,q2;
//  load(q2,"fcijb");
////  std::cout << "start to =" << std::endl;
//  q1 = q2;
////  std::cout << q1 << std::endl;
////  std::cout << q2 << std::endl;
////    std::cout << "end of =" << std::endl;
//  ASSERT_EQ(q1,q2);
////    std::cout << "start to clear" << std::endl;
//  q2.clear();
//  load(q2,"ab");
//  q1 = q2;
//  ASSERT_EQ(q1,q2);
...
//
//
//  PriorityQueueTypeStr::Iterator it2(q.begin());
//  PriorityQueueTypeStr::Iterator it3(q.begin());
//
//  it2.erase();
...
//  PriorityQueueTypeStr q;
////  std::cout << "start unload" << std::endl;
//  load(q,"fcijbdegah");
//  ASSERT_TRUE(unload(q,"abcdefghij"));
////  std::cout << "finish unload" << std::endl;
//
//  //copy
//  load(q,"fcijbdegah");
////  std::cout << "begin to load" << std::endl;
//  PriorityQueueTypeStr q2(q);
////    std::cout << "finish to load" << std::endl;
//  ASSERT_EQ(q,q2);
//  ASSERT_TRUE(unload(q, "abcdefghij"));
//  ASSERT_NE(q,q2);
...
//  //gt specified in neither Template nor Constructor: must fail
//  try {
...
//  }
//
//  //gt specified in both Template and Constructor: must fail
//  try {
