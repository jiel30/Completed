...
typedef ics::HeapPriorityQueue<CorpusEntry> CorpusPQ;     //Convenient to supply gt at construction
...
//  read_corpus time                   = 83.9516
//  print_corpus (sort not print) time = 3266.09

//Almost All Array Implementations (except HeapPriorityQueue and BSTMap)
//  read_corpus time                   = 1.81888
//  print_corpus (sort not print) time = 0.293152
